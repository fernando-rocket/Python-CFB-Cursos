...
pastaApp = "C:/Users/Fernando/PycharmProjects/pythonProject//forms_tkinter.py"
def openWindow():
    exec(open(pastaApp).read(), {'x': 10})
...
menuContatos.add_command(label="Novo", command=openWindow)
